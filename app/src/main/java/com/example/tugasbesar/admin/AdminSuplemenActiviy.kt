...
//        setContentView(R.layout.activity_admin_suplemen_activiy)
...
//            val i = Intent(this@AdminSuplemenActiviy, AddEditActivity::class.java)
...
//
//                if(!suplemen.isEmpty())
//                    Toast.makeText(this@AdminSuplemenActiviy, "Data Berhasil Diambil!", Toast.LENGTH_SHORT)
//                        .show()
//                else
//                    Toast.makeText(this@AdminSuplemenActiviy, "Data Kosong!", Toast.LENGTH_SHORT)
//                        .show()
...
//                    Toast.makeText(
//                        this@AdminSuplemenActiviy,
//                        errors.getString("message"),
//                        Toast.LENGTH_SHORT
//                    ).show()
//                } catch (e: Exception) {
//                    Toast.makeText(this@AdminSuplemenActiviy, e.message, Toast.LENGTH_SHORT).show()
//                }
//            }) {
...
//                if(mahasiswa != null)
//                    Toast.makeText(this@AdminSuplemenActiviy, "Data Berhasil Dihapus", Toast.LENGTH_SHORT).show()
//                allObat()
//            }, Response.ErrorListener { error ->
//                setLoading(false)
//                try {
